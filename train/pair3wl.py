...
from core.data import RookShrikhandeDataset, calculate_stats
...
def create_dataset(cfg): 
    ...
    root = 'data/pair3wl'
    dataset = RookShrikhandeDataset(root, transform=transform)
...
if __name__ == '__main__':
    # get config 
    cfg.merge_from_file('train/configs/pair3wl.yaml')
    cfg = update_cfg(cfg)
